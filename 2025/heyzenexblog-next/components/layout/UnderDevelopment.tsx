...
const UnderDevelopment = () => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-2 gap-7 lg:gap-4 w-full">
			<div className="rounded-2xl w-full h-[50vh] md:h-[65vh]">
				<ImageWithSkeleton src={faker.image.url()}></ImageWithSkeleton>
			</div>
			<div className="rounded-2xl lg:content-center">
